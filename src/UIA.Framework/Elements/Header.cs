namespace UIA.Framework.Elements
{
    ...
    /// <summary>
    /// Wrapper for <see cref="AutomationElement"/> with <see cref="ControlType"/> <see cref="ControlType.Header"/>.
    /// </summary>
    public class Header : Element, IHeader
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Header"/> class.
        /// </summary>
        /// <param name="element"><see cref="AutomationElement"/> with <see cref="ControlType"/> <see cref="ControlType.Header"/>.</param>
        public Header(AutomationElement element)
            : base(element)
        {
        }
